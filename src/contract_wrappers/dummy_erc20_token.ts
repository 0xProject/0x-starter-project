...
export class DummyERC20TokenContract extends BaseContract {
    ...
    public mint = {
        async sendTransactionAsync(
            ...
            const encodedData = self._lookupEthersInterface('mint(uint256)').functions.mint(
                _value
            ).data;
            const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                {
        ...
        getABIEncodedTransactionData(
            ...
            const abiEncodedTransactionData = self._lookupEthersInterface('mint(uint256)').functions.mint(
                _value
            ).data;
            return abiEncodedTransactionData;
        },
    ...
    _value
            ...
            const encodedData = self._lookupEthersInterface('setBalance(address,uint256)').functions.setBalance(
                _target,
                _value
            ).data;
            const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
    ...
    _value
            ...
            const abiEncodedTransactionData = self._lookupEthersInterface('setBalance(address,uint256)').functions.setBalance(
                _target,
                _value
            ).data;
            return abiEncodedTransactionData;
